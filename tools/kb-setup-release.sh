...
. sources/meta-kb/tools/setup-utils.sh
...
FSL_EULA_FILE=$CWD/sources/meta-kb/EULA.txt
...
META_FSL_BSP_RELEASE="${CWD}/sources/meta-kb/meta-bsp"

echo "" >> $BUILD_DIR/conf/bblayers.conf
echo "# i.MX Yocto Project Release layers" >> $BUILD_DIR/conf/bblayers.conf
hook_in_layer meta-kb/meta-bsp
hook_in_layer meta-kb/meta-sdk
hook_in_layer meta-kb/meta-ml
