...
KB_FIRMWARE_SRC ?= "git://github.com/kingbrother-public/kb-firmware.git;protocol=https"
SRC_URI += " \
           ${KB_FIRMWARE_SRC};branch=main;destsuffix=kb-firmware;name=kb-firmware \
"
SRCREV_kb-firmware = "bbe8c4f7eaa070adb7bfea1b150522094fe46e60"
...
do_install_append () {
    ...
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6212/fw_bcm43438a1_apsta.bin ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6212/fw_bcm43438a1.bin ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6212/fw_bcm43438a1_p2p.bin ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6212/nvram_ap6212a.txt ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6212/bcm43438a1.hcd ${D}${nonarch_base_libdir}/firmware/bcmd

    # Install AP6256 firmware
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6256/fw_bcm43456c5_ag_apsta.bin ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6256/fw_bcm43456c5_ag.bin ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6256/nvram_ap6256.txt ${D}${nonarch_base_libdir}/firmware/bcmd
    install -m 0644 ${WORKDIR}/kb-firmware/brcm/AP6256/BCM4345C5_AP6256_CL1.hcd ${D}${nonarch_base_libdir}/firmware/bcmd
}
